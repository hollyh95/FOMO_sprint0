# Generated by Django 2.0.1 on 2018-02-22 23:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(auto_now_add=True, null=True)),
                ('last_modified', models.DateTimeField(auto_now=True, null=True)),
                ('type', models.TextField(choices=[('BulkProduct', 'Bulk Product'), ('IndividualProduct', 'Individual Product'), ('RentalProduct', 'Rental Product')], default='BulkProduct')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_rental_days', models.IntegerField(default=0, null=True)),
